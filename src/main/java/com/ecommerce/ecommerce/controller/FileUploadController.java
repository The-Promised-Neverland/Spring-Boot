...
public class FileUploadController {
    ...
    public FileUploadController(@Value("${upload.directory}") String uploadDirectory) {
    ...
    public ResponseEntity<Resource> downloadFile(@PathVariable("fileName") String fileName) {
        ...
        logger.info("File Path: " + filePath); // Add this line for logging
        ...
        if (resource.exists()) {
            ...
            logger.info("contentType: " + contentType); // Add this line for logging
